...
namespace ProxyProject_Backend.Migrations
{
    ...
    [Migration("20230502152219_Add-verification-code")]
            ...
            modelBuilder.Entity("ProxyProject_Backend.DAL.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            APIKey = "Goet5S-m3j5uSvl4ySnQWYbq1xnX6ISK",
                            AccessFailedCount = 0,
                            Balance = 0m,
                            ConcurrencyStamp = "0df0f9c6-605f-485f-8f12-bdbc3e651260",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOqrUbDSDbY7HKQgOcUt3oMG0Edyj6BXwbxEAYvNB6VADu44gH6LC5EkJd2QtwT0pg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2bb75c19-6d87-4cc3-a21e-3b65f95a4615",
                            TotalDeposited = 0m,
                            TwoFactorEnabled = true,
                            UserName = "admin",
                            WalletKey = "5DfPr3jeXqoPfwJMW4d9bUbsITRlT6tF"
                        });
                });

            modelBuilder.Entity("ProxyProject_Backend.DAL.Entities.VerificationCodeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
